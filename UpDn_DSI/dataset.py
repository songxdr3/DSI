...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, dictionary, dataroot='../data', dataset='cpv2',
                 use_hdf5=True, cache_image_features=False, class_=None):
        ...
        if use_hdf5:
            ...
            self.image_id2ix['train'] = cPickle.load(
                open(os.path.join(dataroot, 'detection_features', f'train36_imgid2img.pkl'), 'rb'), encoding="latin1")
            self.image_id2ix['val'] = cPickle.load(
                open(os.path.join(dataroot, 'detection_features', f'val36_imgid2img.pkl'), 'rb'), encoding="latin1")
        else:
    ...
    def __getitem__(self, index):
        ...
        return features, ques, target, q_id, cls
