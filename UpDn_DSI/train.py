...
def adjusted_labels(labels, head_classes, tail_classes, mid_classes, delta_head=0.13, delta_tail=0.00, delta_mid=0.00):
    ...
    head_classes: Head Category Index
    tail_classes: Tail Category Index
    delta_head: Head delta
    delta_tail: Tail delta
    """
...
def train(model, qmodel, train_loader, eval_loader, qid2type, args):
    ...
    head_threshold = int(0.4 * num_classes)  # head
    mid_threshold = int(0.7 * num_classes)  # head+tail
